                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="idpegawai" class="form-control <?= ($validation->hasError('idpegawai')) ? 'is-invalid' : (old('idpegawai') ? 'is-valid' : '') ?>" value="<?= (old('idpegawai')) ?>" id="colFormLabel" placeholder="Masukan ">
                                        <div id="" class="invalid-feedback">
