                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="keternagan" class="form-control <?= ($validation->hasError('tempat_mutasi')) ? 'is-invalid' : (old('tempat_mutasi') ? 'is-valid' : '') ?>" id=""><?= (old('keterangan')) ?></textarea>
                                        <div id="" class="invalid-feedback">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="idpegawai" class="form-control select2bs4  <?= ($validation->hasError('idpegawai')) ? 'is-invalid' : (old('idpegawai') ? 'is-valid' : '') ?>" style="width: 100%;">
                                            <option>Pilih Nama Pegawai...</option>
                                            <?php foreach ($pegawai as $key => $value) : ?>
                                                <option value="<?= $value->idpegawai ?>" <?= (old('idpegawai')) ? 'Selected' : '' ?>><?= $value->nama ?></option>
                                            <?php endforeach ?>
                                        </select>
                                        <div id="" class="invalid-feedback">
