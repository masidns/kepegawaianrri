        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('mutasi/create') ?>" class="btn-sm btn-success float-right"><i
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a type="button" class="btn-sm btn-primary" data-toggle="modal"
                                        data-target="#modal-default-<?= $value->idmutasi ?>"><i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?= base_url('/mutasi/update/' . $value->idmutasi) ?>"
                                        class="btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                    <a href="<?= base_url('/mutasi/delete/' . $value->idmutasi) ?>"
                                        class="btn-sm btn-danger btn-hapus"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
